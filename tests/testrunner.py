...
class AddonTestCase(unittest.TestCase):
    ...
    def retryAssert(self, *args, **kwargs):
        ...
        # hackAddonModule() is called. Do not import it at the
        # module level.
        #from addon.utils import retry
...
class AddonTestResult(result.TextTestResult):
    def __init__(self, *args, **kwargs):
...
class AddonTestRunner(core.TextTestRunner):
    def __init__(self, *args, **kwargs):
        core.TextTestRunner.__init__(self, *args, **kwargs)

    def _makeResult(self):
        return AddonTestResult(self.stream,
                              self.descriptions,
                              self.verbosity,
                              self.config)
...
def run():
    ...
    runner = AddonTestRunner(stream=conf.stream,
